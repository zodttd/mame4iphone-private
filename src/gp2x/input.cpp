...
static void updatekeyboard(void)
{
	...
	key[KEY_ESC]=((ExKey1 & GP2X_ESC));
	key[KEY_P]=((ExKey1 & GP2X_L) && (ExKey1 & GP2X_R) && (!(ExKey1 & GP2X_START)));

	//key[KEY_TILDE]=((ExKey1 & GP2X_VOL_UP) && (ExKey1 & GP2X_VOL_DOWN));
	//key[KEY_LEFT]=((!(ExKey1 & GP2X_VOL_UP)) && (ExKey1 & GP2X_VOL_DOWN));
	//key[KEY_RIGHT]=((ExKey1 & GP2X_VOL_UP) && (!(ExKey1 & GP2X_VOL_DOWN)));
}
