...
static int show_options(char *game)
{
	...
	f=fopen(text,"r");
	if (f) {
		fscanf(f,"%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d",&gp2x_freq,&gp2x_video_depth,&gp2x_video_aspect,&gp2x_video_sync,
		&gp2x_frameskip,&gp2x_sound,&gp2x_clock_cpu,&gp2x_clock_sound,&gp2x_cpu_cores,&gp2x_ramtweaks,&i,&gp2x_cheat);
		fclose(f);
	}
	...
	while(1)
	{
		...
		{
			case -1: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+40,"Video Depth   Auto"); break;
			case 8:  gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+40,"Video Depth   8 bit"); break;
			case 16: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+40,"Video Depth   16 bit"); break;
		}

		/* (2) Video Aspect */
		switch (gp2x_video_aspect)
		{
			case 0: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Normal"); break;
			case 1: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Scale"); break;
			case 2: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  4:3"); break;
			case 3: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Scale 4:3"); break;
			case 4: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Border"); break;
			case 5: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Border Scale"); break;
			case 6: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Border 4:3"); break;
			case 7: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Border Scale 4:3"); break;
			case 8: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Rotate"); break;
			case 9: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Rotate Scale"); break;
			case 10: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Rotate 4:3"); break;
			case 11: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Rotate Scale 4:3"); break;
			case 12: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Rotate Border"); break;
			case 13: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Rotate Border Scale"); break;
			case 14: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Rotate Border 4:3"); break;
			case 15: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  Rotate Border S4:3"); break;
			case 16: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  TATE"); break;
			case 17: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  TATE Scale"); break;
			case 18: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  TATE 4:3"); break;
			case 19: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  TATE Scale 4:3"); break;
			case 20: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  TATE Border"); break;
			case 21: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  TATE Border Scale"); break;
			case 22: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  TATE Border 4:3"); break;
			case 23: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+50,"Video Aspect  TATE Border S4:3"); break;
		}
		
		/* (3) Video Sync */
		switch (gp2x_video_sync)
		{
			case 1: gp2x_gamelist_text_out(x_Pos,y_Pos+60, "Video Sync    VSync"); break;
			case 0: gp2x_gamelist_text_out(x_Pos,y_Pos+60, "Video Sync    Normal"); break;
			case 2: gp2x_gamelist_text_out(x_Pos,y_Pos+60, "Video Sync    DblBuf"); break;
		...
		if(gp2x_frameskip==-1) {
			...
			gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+70,"Frame-Skip    %d",gp2x_frameskip);
		}
		...
		switch(gp2x_sound)
		{
			...
			case 1: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (15 KHz fast)"); break;
			...
			case 5: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (11 KHz fast)"); break;
			case 6: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (15 KHz)"); break;
			case 7: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (22 KHz)"); break;
			case 8: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (33 KHz)"); break;
			case 9: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (44 KHz)"); break;
			case 10: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (11 KHz)"); break;
			case 11: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (15 KHz stereo)"); break;
			case 12: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (22 KHz stereo)"); break;
			case 13: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (33 KHz stereo)"); break;
			case 14: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (44 KHz stereo)"); break;
			case 15: gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+80,"Sound         %s","ON (11 KHz stereo)"); break;
		}

		/* (6) CPU Clock */
		gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+90,"CPU Clock     %d%%",gp2x_clock_cpu);

		/* (7) Audio Clock */
		gp2x_gamelist_text_out_fmt(x_Pos,y_Pos+100,"Audio Clock   %d%%",gp2x_clock_sound);
		...
		/* (9) RAM Tweaks */
		if (gp2x_ramtweaks)
			gp2x_gamelist_text_out(x_Pos,y_Pos+120,"RAM Tweaks    ON");
		else
			gp2x_gamelist_text_out(x_Pos,y_Pos+120,"RAM Tweaks    OFF");
		...
		else if(ExKey & GP2X_R || ExKey & GP2X_L)
		{
			...
			case 7:
				...
				break;
			case 8:
				gp2x_cpu_cores=(gp2x_cpu_cores+1)%4;
				break;
			case 9:
		...
		if ((ExKey & GP2X_A) || (ExKey & GP2X_B) || (ExKey & GP2X_PUSH) || (ExKey & GP2X_START)) 
		{
			...
			f=fopen(text,"w");
			if (f) {
				fprintf(f,"%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d",gp2x_freq,gp2x_video_depth,gp2x_video_aspect,gp2x_video_sync,
				gp2x_frameskip,gp2x_sound,gp2x_clock_cpu,gp2x_clock_sound,gp2x_cpu_cores,gp2x_ramtweaks,i,gp2x_cheat);
				fclose(f);
				sync();
			}
...
void execute_game (char *playgame)
{
	...
	/* gp2x_cpu_cores */
	if ((gp2x_cpu_cores==1) || (gp2x_cpu_cores==3))
	{
		args[n]="-cyclone"; n++;
	}
...
int main (int argc, char **argv)
{
	...
	if (f) {
		fscanf(f,"%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d",&gp2x_freq,&gp2x_video_depth,&gp2x_video_aspect,&gp2x_video_sync,
		&gp2x_frameskip,&gp2x_sound,&gp2x_clock_cpu,&gp2x_clock_sound,&gp2x_cpu_cores,&gp2x_ramtweaks,&last_game_selected,&gp2x_cheat);
		fclose(f);
	}
