...
unsigned hd6309_get_context(void *dst) { return m6809_get_context(dst); }
void hd6309_set_context(void *src) { m6809_set_context(src); }
unsigned hd6309_get_pc(void) { return m6809_get_pc(); }
void hd6309_set_pc(unsigned val) { m6809_set_pc(val); }
unsigned hd6309_get_sp(void) { return m6809_get_sp(); }
void hd6309_set_sp(unsigned val) { m6809_set_sp(val); }
...
void hd6309_set_nmi_line(int state) { m6809_set_nmi_line(state); }
