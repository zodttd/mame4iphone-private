...
$(OBJ)/cpu/z80/z80.o: z80.cpp z80.h z80daa.h
endif
...
$(OBJ)/cpu/m6809/m6809.o: m6809.cpp m6809.h 6809ops.cpp 6809tbl.cpp
endif
...
ASMDEFS += -DA68KEM
$(OBJ)/cpu/m68000/68kem.o: $(OBJ)/cpu/m68000/68kem.asm make68k.cpp
else
OBJDIRS += $(OBJ)/cpu/m68000
...
$(OBJ)/cpu/tms34010/tms34010.o: tms34010.cpp tms34010.h 34010ops.cpp 34010tbl.cpp
endif
