...
//*******************************************************************************************
// Determines if hosts file has been modified for ad blocking.
//*******************************************************************************************
+ (BOOL) isAdBlockingEnabled
{
	...
	if(fp != NULL)
	{
		while(!feof(fp))
		{
			if(fgets(Temp, 95, fp) == NULL) break;
			if(strstr(Temp, "mm.admob.com") != NULL ||
			   strstr(Temp, "www.zodttd.com") != NULL)
			{
				Blocked = YES;
				break;
			}
